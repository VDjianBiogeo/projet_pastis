---
title: "`r paste('Finding the', params$cardinal_point, 'in the hearts of french people')`"
format: html
editor: visual
params: 
  cardinal_point: "_south"
execute:
  echo: false
  error: true
  warning: false
...
```{r}
tar_load(pca_survey_graph_south)

pca_survey_graph_south
```
...
```{r}
tar_load(pca_map_survey_south)

pca_map_survey_south
```
